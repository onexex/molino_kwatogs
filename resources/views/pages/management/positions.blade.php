...
<div class="container-fluid px-4 py-3">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <button type="button" class="btn btn-primary rounded-pill px-4 shadow-sm fw-bold" id="btnAddPosition" data-bs-toggle="modal" data-bs-target="#mdlPosition">
                ...
                <table class="table table-hover align-middle table-sticky-header mb-0">
                    <thead class="bg-light">
                        <tr class="text-secondary small fw-bold text-uppercase tracking-wider">
                            <th class="ps-4 py-3">Position Title</th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow rounded-4">
                ...
                <div class="modal-body p-4">
                    <form id="frmPosition">
                        <div class="form-group mb-0">
                            <label for="txtPosition" class="form-label small fw-semibold text-muted">Position Title <span class="text-danger">*</span></label>
                            <input class="form-control form-control-lg bg-light border-0 fs-6" id="txtPosition" name="position" type="text" placeholder="e.g. Graphic Designer" />
                ...
                <div class="modal-footer border-0 pb-4 px-4">
                    ...
                    <button id="btnSavePosition" type="button" class="btn btn-primary rounded-pill px-5 fw-bold shadow-sm">Save Position</button>
                </div>
            </div>
        </div>
    </div>
