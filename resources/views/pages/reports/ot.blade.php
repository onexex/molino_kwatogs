...
<div class="container-fluid">
    <div class="mb-2">
        <h4 class="text-gray-800 mb-3">Overtime Viewer</h4>
    </div>
                            ...
                            <table class="table table-hover ">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Date Time Filing</th>
                                ...
                                <tbody id="tblOT">
                                    <tr>
                                        <td>1</td>
                                        <td>Gemana, Ramon Jr</td>
                                        <td>August 30, 2022 01:59:46 PM</td>
                                        <td>August 27, 2022 08:00:00 AM</td>
                                        <td>August 27, 2022 07:00:00 PM</td>
                                        <td>11</td>
...
<script src="{{ asset('js/report/ob.js') }}" defer></script>
@endsection    