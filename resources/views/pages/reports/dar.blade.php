...
<div class="container-fluid">
    <div class="mb-2">
        <h4 class="text-gray-800 mb-3">Daily Activity Report Viewer</h4>
    </div>
                            ...
                            <table class="table table-hover ">
                                ...
                                <tbody id="tblDAR">
                                    <tr>
                                        ...
                                        <td>1</td>
                                        <td>Aquino, Bianca</td>
                                        <td>September 27, 2022 07:02:15 PM</td>
                                        <td>Logged Out from Cenar</td>
                                    </tr>
                                </tbody>
                                <tfoot class="p-3">
                                    <tr>
...
<script src="{{ asset('js/report/dar.js') }}" defer></script>
@endsection    