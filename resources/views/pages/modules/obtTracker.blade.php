...
<div class="container-fluid">
    ...
    <div class="mb-2">
        ...
        <button class=" mt-3 btn btn-danger radius-1" name="btnCreateOBTModal" id="btnCreateOBTModal" data-bs-toggle="modal" data-bs-target="#mdlOBT"> <i class="fa fa-plus"></i> Official Business Trip Form</button>
    </div>
    ...
    <div class="row mt-2">
                            ...
                            <table class="table table-hover table-border-none  ">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-dark" scope="col">TimeFrom</th>
                                        <th class="text-dark" scope="col">TimeTo</th>
                                        <th class="text-dark" scope="col">ItineraryFrom</th>
     ...
     <!-- Modal OOBT Form-->
     <div class="modal fade" id="mdlOBT" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="background-color: rgb(249 200 200 / 17%);">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-danger dragable_touch" >
                    <h5 class="modal-title fst-italic text-white" id="staticBackdropLabel"><label for="" class="" id="lblTitleOBT"> Official Business Trip Form</label></h5>
                            ...
                            <form action="" id="frmOBT">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mb-2">
                                                <div class="form-floating">
                                                    ...
                                                    {{-- <input class="form-control" value="{{date('Y-m-d')}}" id="txtFilingDate" name="dateFil" type="text" placeholder="-" readonly/> --}}
                                            ...
                                            <div class="col-lg-12 mb-2">
                                                <div class="form-floating">
                                                    ...
                                                    <label class="form-check-label" for="txtDateFromOB">OB Date From <label for="" class="text-danger">*</label></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="row">
                                            <h5 class="my-1 text-gray-800">CASH ADVANCE</h5>

                                            <div class="col-lg-12 mb-2">
                                                <div class="form-floating">
                                                    <input class="form-control" id="txtCAAmount" name="amount" type="number" placeholder="-"/>
                                                    <label class="form-check-label" for="txtCAAmount">Amount </label>
                                            ...
                                            <div class="col-lg-12 mb-2">
                                                <div class="form-floating">
                                                    ...
                                                    <label class="form-check-label" for="txtPurposeITime">Purpose</label>
                ...
                <div class="modal-footer">
                    ...
                    <button  id="btnSaveOBT" type="button" class="btn btn-secondary ">Submit</button>
                </div>
            </div>
        </div>
    </div>
...
<script src="{{ asset('js/modules/obs.js') }}" defer></script>
@endsection
